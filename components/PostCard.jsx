...
const PostCard = ({ post }) => (
  <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
    ...
    <div className="relative overflow-hidden shadow-md pb-80 mb-6">
      <img src={post.featuredImage.url} alt="" className="object-top absolute h-90 w-full object-cover  shadow-lg rounded-t-lg lg:rounded-lg" />
    </div>
    {/* <div className="">
    ...
    <h1 className="transition duration-700 text-center mt-6 mb-3 cursor-pointer hover:text-pink-600 text-3xl font-semibold">
